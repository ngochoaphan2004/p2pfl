...
BASE = Path(__file__).resolve().parents[2]  # lên tới p2pfl
LOG = BASE / "logs"
LOG_CONFIG = {
    "DFedAdp": [str(LOG / "30n-100r-random-dfedadp-noVote.log"),
                str(LOG / "30n-100r-random-dfedadp-noVote.log.1"),
                str(LOG / "30n-100r-random-dfedadp-noVote.log.2"),
                str(LOG / "30n-100r-random-dfedadp-noVote.log.3")],
    "FedAvg": [str(LOG / "30n-100r-random-fedavg-noVote.log"),
               str(LOG / "30n-100r-random-fedavg-noVote.log.1"),
               str(LOG / "30n-100r-random-fedavg-noVote.log.2"),
               str(LOG / "30n-100r-random-fedavg-noVote.log.3")],
}
